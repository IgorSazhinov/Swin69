      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-8 right-8 z-[10000] w-[90vw] max-w-[500px] h-[40vh] max-h-[500px] bg-[#064e3b] rounded-[30px] border-[3px] border-orange-500 shadow-2xl overflow-hidden flex flex-col"
          ...
          >
            ...
            <div className="flex border-b border-white/10">
              <button
                ...
                className={`flex-1 py-0.5 text-center font-black uppercase text-[10px] tracking-tighter transition-all relative ${
                  activeTab === "chat"
                    ? "text-orange-500"
                        ...
                        {messages.map((msg, idx) => (
                          ...
                          >
                            <div className="flex items-center gap-2 mb-1">
                              <span
                                className={`font-bold text-xs ${msg.isMyMessage ? "text-orange-300" : "text-cyan-300"}`}
                              >
                                {msg.playerName}
                              </span>
                            ...
                            <div
                              className={`w-2 h-2 rounded-full ${
                                log.action?.includes("win")
                                  ? "bg-yellow-500"
                                  : log.action?.includes("khapezh")
                                    ? "bg-red-500"
                                    : log.action?.includes("chlop")
                                      ? "bg-purple-500"
                                      : log.action?.includes("play")
                                        ? "bg-green-500"
                                        : "bg-blue-500"
                              }`}
                            />
